...
const Signup = () => {
  ...
  function handleSubmit(e) {
    ...
    if (!form.pincode) errorsObj.pincode = "Pincode is required";
    if (!form.gender) errorsObj.gender = "Gender is required";
    if (!form.occupation) errorsObj.occupation = "Occupation is required";
    if (!form.company) errorsObj.company = "Company is required";
    if (!form.website) errorsObj.website = "Website is required";
    if (!form.bio) errorsObj.bio = "Bio is required";
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input
        ...
        placeholder="Age"
        onChange={(e) => setForm({ ...form, age: e.target.value })}
        style={{ border: error.age ? "2px solid red" : "" }}
      />
      ...
      <input
        ...
        placeholder="Address"
        onChange={(e) => setForm({ ...form, address: e.target.value })}
        style={{ border: error.address ? "2px solid red" : "" }}
      />
      ...
      <input
        ...
        placeholder="City"
        onChange={(e) => setForm({ ...form, city: e.target.value })}
        style={{ border: error.city ? "2px solid red" : "" }}
      />
      ...
      <input
        ...
        placeholder="State"
        onChange={(e) => setForm({ ...form, state: e.target.value })}
        style={{ border: error.state ? "2px solid red" : "" }}
      />
      ...
      <input
        ...
        placeholder="Phone"
        onChange={(e) => setForm({ ...form, phone: e.target.value })}
        style={{ border: error.phone ? "2px solid red" : "" }}
      />
      ...
      <input
        ...
        placeholder="Pincode"
        onChange={(e) => setForm({ ...form, pincode: e.target.value })}
        style={{ border: error.pincode ? "2px solid red" : "" }}
      />
      ...
      <input
        ...
        placeholder="Occupation"
        onChange={(e) => setForm({ ...form, occupation: e.target.value })}
        style={{ border: error.occupation ? "2px solid red" : "" }}
      />
      ...
      <input
        ...
        placeholder="Company"
        onChange={(e) => setForm({ ...form, company: e.target.value })}
        style={{ border: error.company ? "2px solid red" : "" }}
      />
      ...
      <input
        ...
        placeholder="Website"
        onChange={(e) => setForm({ ...form, website: e.target.value })}
        style={{ border: error.website ? "2px solid red" : "" }}
      />
      ...
      <input
        ...
        placeholder="Bio"
        onChange={(e) => setForm({ ...form, bio: e.target.value })}
        style={{ border: error.bio ? "2px solid red" : "" }}
      />
