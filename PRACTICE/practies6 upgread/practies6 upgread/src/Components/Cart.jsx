...
import { addCart, removeCart, clearCart } from "../Slice/cartSlice";
  ...
  return (
    <div className="min-h-screen p-6 bg-gray-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
        {sortedData.map((p) => (
          <div key={p.id} className="bg-white p-4 rounded-2xl shadow-lg">
            <img
              src={p.thumbnail}
              alt={p.title}
      ...
      <div className="mt-10 bg-white p-5 rounded-2xl shadow-lg">
        <h1 className="text-2xl font-bold mb-5">Redux Cart Items</h1>
